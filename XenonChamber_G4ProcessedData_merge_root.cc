...
//const char *TreeName = "G4Data";
const char *TreeName = "tData";

void XenonChamber_G4ProcessedData_merge_root()
{
    using namespace std;
    ...
    while(cin >> filename) {
        ...
        if(TTree *tree = (TTree *)f->Get(TreeName)) {
            ...
            cout << "Didn't find corresponding TTree as named: "<<TreeName<< endl;
        }
    }
